...
public class Classification {
   ...
   * @throws Classification.Vect.Reader.WrongNumbersCountException
   */
  public Classification(String filename, int size)
          throws FileNotFoundException,
          Vect.Reader.WrongNumbersCountException {
    this.n = size - 1;
    Vect.Reader.Result readerResult = Vect.Reader.readFromFile(filename, n);
  ...
  public String test() {
    String result = "";
    Iterator<Vect> it = vectors.iterator();
    while (it.hasNext()) {
      Vect vector = it.next();
   ...
   */
  public static class Vect extends ArrayList<Double> {

    static final long serialVersionUID = 2;
    private Vect normalized = null;
    ...
    public static class Reader {
       ...
       * @throws Classification.Vect.Reader.WrongNumbersCountException
       */
      private static Vect scanVector(Scanner sc, int n)
     ...
     */
    public static class Vectors extends ArrayList<Vect> {
  ...
  public static class NeuralNetwork {
    ...
    public static class Probe {
       ...
       * @param vector vector
       */
      public Probe(int cls, Vect vector) {
        this.expected = cls;
        this.vector = vector;
      }
     ...
     */
    public int classify(Vect input) {
    ...
    private static class Neuron {
       ...
       */
      public void setInput(Vect vector) {
      ...
      public static class Layer extends HashMap<Integer, Neuron> {
         ...
         */
        public void setInput(Vect input) {
          for (Integer nxtKey : keySet()) {
